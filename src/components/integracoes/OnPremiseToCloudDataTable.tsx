...
import { OnPremiseToCloud, Aplicacao } from '@/lib/types';
...
interface OnPremiseToCloudDataTableProps {
  data: OnPremiseToCloud[];
  aplicacoes: Aplicacao[];
  onEdit: (item: OnPremiseToCloud) => void;
...
export function OnPremiseToCloudDataTable({ data, aplicacoes, onEdit, onDelete }: OnPremiseToCloudDataTableProps) {
    ...
    <Card>
      <CardHeader>
        <div className="space-y-4">
          <CardTitle>Integrações OnPremise to Cloud</CardTitle>
