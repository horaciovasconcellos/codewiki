...
import { UserToCloud, Integracao, Comunicacao, TipoDispositivo, TipoAutenticacao, Periodicidade, FrequenciaUso } from '@/lib/types';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';

interface UserToCloudFormProps {
  data?: UserToCloud;
  integracaoAtual?: Integracao;
  comunicacoes: Comunicacao[];
  onSave: (data: UserToCloud) => void;
  onCancel: () => void;
}
...
export function UserToCloudForm({ data, integracaoAtual, comunicacoes, onSave, onCancel }: UserToCloudFormProps) {
