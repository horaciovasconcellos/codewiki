...
import { OnPremiseToCloud, Integracao, Comunicacao, Aplicacao, TipoAutenticacao, Periodicidade, FrequenciaUso } from '@/lib/types';
import { Button } from '@/components/ui/button';
import { Label } from '@/components/ui/label';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';

interface OnPremiseToCloudFormProps {
  data?: OnPremiseToCloud;
  integracaoAtual?: Integracao;
  integracoes?: Integracao[];
  aplicacoes: Aplicacao[];
  comunicacoes: Comunicacao[];
  onSave: (data: OnPremiseToCloud) => void;
  onCancel: () => void;
}
...
export function OnPremiseToCloudForm({ data, integracaoAtual, integracoes, aplicacoes, comunicacoes, onSave, onCancel }: OnPremiseToCloudFormProps) {
