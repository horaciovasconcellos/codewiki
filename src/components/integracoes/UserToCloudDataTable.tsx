...
import { UserToCloud } from '@/lib/types';
...
interface UserToCloudDataTableProps {
  data: UserToCloud[];
  onEdit: (item: UserToCloud) => void;
...
export function UserToCloudDataTable({ data, onEdit, onDelete }: UserToCloudDataTableProps) {
    ...
    <Card>
      <CardHeader>
        <div className="space-y-4">
          <CardTitle>Integrações User to Cloud</CardTitle>
