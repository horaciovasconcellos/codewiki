...
import { CloudToCloud, Aplicacao } from '@/lib/types';
...
interface CloudToCloudDataTableProps {
  data: CloudToCloud[];
  aplicacoes: Aplicacao[];
  onEdit: (item: CloudToCloud) => void;
...
export function CloudToCloudDataTable({ data, aplicacoes, onEdit, onDelete }: CloudToCloudDataTableProps) {
    ...
    <Card>
      <CardHeader>
        <div className="space-y-4">
          <CardTitle>Integrações Cloud to Cloud</CardTitle>
