# Exemplo de Aplicação - PAYLOADORDSPLCLARA
...
**Status:** 🟢 Ativo  
**Descrição Curta:** PAYLOADORDSPLCLARA  
**Descrição Longa:** Descricao Curta  
...
<swagger-ui src="PAYLOADORDSPLCLARA.json"/>
...
1. Abra o Postman
2. Clique em "Import"
3. Cole a URL: `http://localhost:5173/json/PAYLOADORDSPLCLARA.json`
4. Clique em "Import"
...
4. Cole a URL: `http://localhost:5173/json/PAYLOADORDSPLCLARA.json`
