...
CREATE TABLE aplicacoes (
  ...
  tipo_aplicacao ENUM('BOT','COTS','INTERNO','MOTS','OSS','OTS','PAAS','SAAS') NOT NULL,
  ...
  cloud_provider ENUM('AWS', 'Microsoft Azure', 'Google Cloud', 'Alibaba Cloud', 'Oracle', 'Salesforce', 'IBM Cloud', 'Tencent Cloud', 'PIIDA', 'ON-PREMISE', 'Outros'),
